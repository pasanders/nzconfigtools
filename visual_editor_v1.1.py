...
class NikonZMenuEditor:
    ...
    def setup_ui(self):
        ...
        # Mode listbox
        self.mode_listbox = tk.Listbox(config_frame, height=10, width=30)
    ...
    def find_config_sections(self):
        ...
        for offset, name in standard_sections_mk2:
            if self.is_valid_config_section(offset):
                ...
                mode_name = self.mode_names.get(mode_id, f"User {mode_id}")
                
                # Avoid redundant labeling for U1, U2, U3
                if name in ["U1", "U2", "U3"]:
                    display_name = name
                    mode_name = name
                else:
                ...
                self.config_sections[display_name] = {
                    'offset': offset,
                    'mode_id': mode_id,
                    'mode_name': mode_name,
                    'source': 'standard_mk2'
